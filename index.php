    ...
    <main class="container py-5">
        ...
        <section class="mt-5">
            <table class="table table-hover">
                ...
                <tbody>
                <?php foreach($todo->getAll() as $result) :?>
                    <tr>
                        <td><?php echo h($result['name']); ?></td>
                        <td><?php echo h($result['due_date']) ?></td>
                        <td>
                            <a class="text-success" href="edit.php?id=<?php echo h($result['id']); ?>">EDIT</a>
                        </td>
                        <td>
                            <a class="text-danger" href="delete.php?id=<?php echo h($result['id']); ?>">DELETE</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                    <!-- <tr>
